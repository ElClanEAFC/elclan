...
public class reHumanosServices {
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 29-08-2022 descripcion: service: listar
     * justificaciones
     *
     * @param codAsistDet
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 25-08-2022 descripcion: service: listar
     * areas para sedes
     *
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 25-07-2022 descripcion: service:
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 25-07-2022 descripcion: service: DAR
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 25-07-2022 descripcion: service: lISTA
     * DE EXPERIENCIAS LABORADAS.
     *
     * @param codUsuario
     * @return 
    *****************************************************************************
     ...
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 25-07-2022 descripcion: service:
     * REGISTRAR EXPERIENCIAS LABORADAS.
     *
     * @param codUsuario
     * @param codPuesto
     * @param descripcion
...
//  ====================== REPORTES DE ASISTENCIAS ======================
    /**
     * **************************************************************************
     * autor: bentu condori m.fecha: 05-08-2022 descripcion: service: Genera el
     * reporte de asistencia en formato TXT.
     *
     * @param codVende
     * @param codAsistDet
     * @param fecha
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori m. fecha: 01-08-2022 descripcion: service: Genera el
     * reporte de asistencia en formato TXT.
     *
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: benturino condori fecha: 26-07-2022 descripcion: service: Lista de
     * asistencias del dia.
     *
     * @param Fecha
     * @param datos
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori m. fecha: 26-07-2022 descripcion: service: confirma
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori m. fecha: 21-07-2022 descripcion: service: lista
     * registro de asistencias del marcador bd access.
     *
     * @param fecIni
     * @param fecFin
     * @return 
...
//  ============================= FINAL DE REPORTES DE ASISTENCIAS ==============================
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 21-07-2022 descripcion: service:
     * Desactivar Usuario.
     *
     * @param codUsuario
     * @param usuario
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 19-07-2022 descripcion: service: Lista
     * Motivos de Baja.
     *
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 18-07-2022 descripcion: service: Dar
     * Baja a Usuario.
     *
     * @param codUsuario
     * @param codMotCese
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 18-07-2022 descripcion: service: Listar
     * Usuarios.
     *
     * @return 
    *****************************************************************************
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 19-07-2022 descripcion: service: Listar
     * Cargos de Usuario.
     *
     * @param codUser
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 15-07-2022 descripcion: service: Asignar
     * Cargo a Usuario.
     *
     * @param codUsuario
     * @param codPerfil
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 15-07-2022 descripcion: service:
     * Actualizar Usuarios.
     *
     * @param codUsuario
     * @param usuNombre
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 15-07-2022 descripcion: service: Listar
     * Paises.
     *
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 13-07-2022 descripcion: service: Guardar
     * Usuarios.
     *
     * @param usuNombre
     * @param usuPaterno
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 12-07-2022 descripcion: service: Validar
     * Numero de Documento.
     *
     * @param codTDoc
     * @param numDoc
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 11-07-2022 descripcion: service: Listar
     * Tipos de documentos.
     *
     * @param codTipoDoc
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 09-08-2022 descripcion: service: DAR
     * BAJA USUARIO DE Sucursal.
     *
     * @param codSucursal
     * @param codUsuario
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 09-08-2022 descripcion: service: Listar
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 07-07-2022 descripcion: service:
     * Desactivar Area en Sucursal.
     *
     * @param codSucursal
     * @param codArea
     * @param usuario
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 08-07-2022 descripcion: service: Agregar
     * Area a Sucursal.
     *
     * @param codSucursal
     * @param codArea
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 08-07-2022 descripcion: service: Listar
     * Areas Sucursal.
     *
     * @param codSucursal
     * @return
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 05-07-2022 descripcion: service: Traer
     * lista de provincias
     *
     * @param codDpto
     * @param codProv
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 05-07-2022 descripcion: service: Guardar
     * nueva sucursal
     *
     * @param nombre
     * @param telefono
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 01-07-2022 descripcion: service: crear
     * nuevos perfiles o cargos segun el area
     *
     * @param codPerfil
     * @param codArea
     * @param codModulos
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 27-06-2022 descripcion: service: obtener
     * lista de submodulos
     *
     * @param codPerfil
     * @param codSubModulo
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 23-06-2022 descripcion: service: obtener
     * lista de submodulos
     *
     * @param codModulo
     * @param codPerfil
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: yasub huaman ramos fecha: 23-06-2022 descripcion: service: crear
     * nuevos perfiles o cargos segun el area
     *
     * @param codArea
     * @param nomPerfil
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 22-06-2022 descripcion: service: crear nuevos
     * perfiles o cargos segun el area
     *
     * @param codPerfil
     * @param usuario
     * @return 
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 16-06-2022 descripcion: service: Retorna el
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 16-06-2022 descripcion: service: lista los
     * perfiles segun el area 
    *****************************************************************************
     */
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 13-06-2022 descripcion: service: desactiva el
     * area
    *****************************************************************************
     */
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 13-06-2022 descripcion: service: actualiza
     * datos del area
    *****************************************************************************
     */
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 08-06-2022 descripcion: service: guarda los
     * datos del area
    *****************************************************************************
     */
    ...
    *****************************************************************************
    ...
    /**
     * **************************************************************************
     * autor: bentu condori fecha: 04-06-2022 descripcion: service: Validacon de
     * usuarios(Login)
     *
     * @param usuario
     * @param pass
    *****************************************************************************
    ...
    public reHumanos listaMotivosSalida() {
        reHumanos resultado = null;
        System.out.println("SERVICE listaMotivosSalida()");
        try {
            resultado = objReHumanosDAO.listaMotivosSalida();
        } catch (Exception e) {
            System.out.println("ERROR EN SERVICE(reHumanosService)>>>(listaMotivosSalida) : " + e.getMessage());
        }
        return resultado;
    }

    public String guardarEncuesta(int codUsuario, String cod_respuesta, String observ, String usuario) {
        String resultado = null;
        System.out.println("SERVICE reHumanosService(guardarEncuesta)");
        try {
            resultado = objReHumanosDAO.guardarEncuesta(codUsuario, cod_respuesta, observ, usuario);
        } catch (Exception e) {
            System.out.println("ERROR EN SERVICE(reHumanosService)>>>(guardarEncuesta) : " + e.getMessage());
        }
        return resultado;
    }
     public reHumanos listaEncuestas(int codUsuario) {
        reHumanos resultado = null;
        System.out.println("SERVICE reHumanosService(listaEncuestas)");
        try {
            resultado = objReHumanosDAO.listaEncuestas(codUsuario);
        } catch (Exception e) {
            System.out.println("ERROR EN SERVICE(reHumanosService)>>>(listaEncuestas) : " + e.getMessage());
        }
        return resultado;
    }
}
