                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 badge bg-danger cabecera">
                                    <div class="row">
                                        <div class="col-10"><h3>Sorteo de adjudicación</h3></div>
                                        <div class="col-2">
                                            <ul>
                                                <li><a href="#" onclick="crearUsuario();" title="Agregar Usuarios"><i class="fas fa-reply"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <div class="row">
                                                    ...
                                                    <div class="col-1">
                                                        <label>Tipo Asamblea</label>
                                                        <select  class="form-control">
                                                            <option> Regular</option>
                                                            <option> Inaugural</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-1">
                                                        <label>Fecha Asamblea</label>
                                                        <select  class="form-control">
                                                            <option> 20/03/2022</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-2">
                                                        <label>N° Bolilla</label>
                                                        <input type="text" name="contrato"  class="form-control">
                                                    </div>
                                                    
                                                    <div class="col-1">
                                                        <label> </label>
                                                        <buttom class="form-control btn btn-success btn-lg text-white">Generar</buttom>
                                                    </div>
                                                    <div class="col-2">
                                                        <label> </label>
                                                        <buttom class="form-control btn btn-success btn-lg text-white"><i class="fas fa-print"></i> Confirmar & Imprimir</buttom>
                                                    </div>
                                                </div>
