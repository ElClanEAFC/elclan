                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 badge bg-danger cabecera">
                                    <div class="row">
                                        <div class="col-10"><h4>DETALLES DE CONTRATO - 200512511</h4></div>
                                        <div class="col-2">
                                            <ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                    <div class="col-9 daContrato">
                                                        <div class="row">
                                                            <div class="col-6"><b>ASOCIADO: </b> Luis Sanchez Tapia</div>
                                                            <div class="col-3"><b>N° DOCUMENTO </b> 46087574</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3"><b>PROGRAMA: </b> V01</div>
                                                            <div class="col-3"><b>GRUPO: </b> 2005</div>
                                                            <div class="col-3"><b>CONTRATO: </b> 200512511</div>
                                                            <div class="col-3"><b>CUPO: </b> 125</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3"><b>CERTIFICADO: </b> 10,000.00</div>
                                                            <div class="col-3"><b>ADJUDICADO: </b> Si(20-01-2022)</div>
                                                            <div class="col-3"><b>ESTADO: </b> Habil - Vigente</div>
                                                            <div class="col-3"><b>F. INGRESO </b> 10-01-2022</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3"><b>MONTO PAGADAS </b> 125.00</div>
                                                            <div class="col-3"><b>CUOTAS PAGADAS: </b> 1</div>
                                                            <div class="col-3"><b>SALDO PENDIENTE: </b> 9,875.00</div>
                                                            <div class="col-3"><b>CUOTAS PENDIENTES </b> 79</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-3 dVentas">
                                                        <div class="row">
                                                            <div class="col-11"><b>PUNTO DE VENTA</b><br>Centro Comercial MEGA PLAZA</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-11"><b>VENDEDOR:</b><br>Carlos Peralta Ramos</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-11"><b>CONTRATOS RELACIONADOS:</b><br>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="table-responsive">
                                                ...
                                                <table id="listaContrato"  class="table datatable-basic ui celled table responsive nowrap unstackable" width="100%" autocomplete="off">
                                                    <thead>
                                                        <tr>
                                                            <th>N° Cuota</th>
                                                            <th>Mes Grupo</th>
                                                    ...
                                                    <tbody id="bodyListaContrato">
                                                        <tr>
                                                            ...
                                                            <td>00.00</td>
                                                            <td>00.00</td>
                                                            <td><i class="fas fa-search-plus ver-mas"></i></td>
                                                            <td><i class="fas fa-search-plus ver-mas"></i></td>               
                                                        </tr>
                                                        <tr class="actual">
                                                            <td>1</td>
