            ...
            <div class="modal-body">
                <div class="row gap-sm-2 gap-md-0">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="row">
                            <div class="col-6">
                                <p class="fw-bold">NOMBRE/RAZ�N SOCIAL:</p>
                            </div>
                            <div class="col-6">
                        ...
                        <form>
                            ...
                            <div class="col-md-10 centrar">
                                <p>
                                    ...
                                    <input type="password" name="claConfir" id="claConfir" class="form-control" placeholder='Ingrese Contrase�a'>
                                </p>
                            </div>   
                        </form>
                ...
                <div class="col-md-12">
                    <div class="d-flex gap-1 justify-content-between flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <button class="btn btn-success text-white " onclick="ROUTER.load('registrar');">A�ADIR USUARIO</button>            
                        </div>        
                    </div>
                    <hr/>
        ...
        let validator = $("#formRegistroUsuario").validate({
            ...
            messages: {
                ...
                usuCelular: {
                    ...
                    inputTrim: "Ingrese un n�mero valido"
                },
                usuCorreo: "Ingrese Correo",
                usuDireccion: {
                    required: "Ingrese Direccion",
                    inputTrim: "Ingrese una direcci�n valida"
                },
