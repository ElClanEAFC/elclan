                                            ...
                                            <div class="table-responsive">
                                                <div class="row">
                                                    ...
                                                    <div class="col-1">
                                                        ...
                                                        <select  class="form-control">
                                                            <option> Habil</option>
                                                            <option> No habil</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-1">
                                                        <label> </label>
                                                        <input type="submit" name="contrato"  class="form-control btn btn-success btn-lg text-white" value="Filtar">
                                                    </div>
                                                </div>
